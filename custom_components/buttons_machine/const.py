...
DIM_CYCLE_MODES={'quick':{_H:10,_I:.25,_J:.25},_N:{_H:5,_I:.35,_J:.35},'paced':{_H:3,_I:.6,_J:.6}}
...
ACTION_TYPE_DOMAINS={ACTION_STATEFUL_SCENE:[_G],ACTION_HA_SCENE:[_G],ACTION_AUTOMATION:[_L],ACTION_SCRIPT:[_M],ACTION_ENTITY_TOGGLE:[_C,_O,'fan',_P,_Q,_K],ACTION_SINGLE_ACTION:[_C,_O,'fan',_P,_Q,_K],ACTION_COVER_CYCLE:[_K],ACTION_DIM_CYCLE:[_C],ACTION_LIGHT_CYCLE_DIM:[_C],ACTION_RAISE:[],ACTION_LOWER:[],ACTION_NONE:[]}
