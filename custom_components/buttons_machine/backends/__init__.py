...
from.z2m import Z2MBackend
from.zen35 import ZEN35Backend
_BACKENDS={_A:CasetaBackend,'control4':Control4Backend,'lip':LipBackend,'rfwc5':RFWC5Backend,'z2m':Z2MBackend,'zen35':ZEN35Backend}
def get_backend(config_entry):
	A=config_entry;B=_A
	if A is not None:B=A.data.get('backend')or _A
	return _BACKENDS.get(B,CasetaBackend)()
__all__=['KeypadBackend','CasetaBackend','Control4Backend','LipBackend','RFWC5Backend','Z2MBackend','ZEN35Backend','get_backend']